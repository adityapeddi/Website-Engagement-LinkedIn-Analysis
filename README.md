...
.
├── pbix/
│   └── website_linkedin_marketing_report.pbix   # Main Power BI report
├── data/
│   ├── google_analytics_sample.csv              # Sample/synthetic GA data
│   └── linkedin_outreach_sample.csv             # Sample/synthetic LinkedIn data
├── images/
│   ├── landing-page.png
│   ├── google-analytics-view.png
│   ├── linkedin-outreach-view.png
│   └── time-series-view.png
└── README.md
